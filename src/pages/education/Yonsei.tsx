      ...
      <div className={styles.rhsFrame}>
        <div className={styles.frame}>
          <div className={styles.experienceHeader}>
            <h1 className={styles.sampleItem}>Yonsei University</h1>
            <div className={styles.frame1}>
              <div className={styles.locationDateContainer}>
                <p className={styles.experienceText}>Seoul, South Korea</p>
                <p className={styles.experienceText}>08/2022 - 12/2022</p>
              </div>
            </div>
          </div>

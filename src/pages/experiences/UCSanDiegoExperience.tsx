      ...
      <div className={styles.rhsFrame}>
        <div className={styles.frame}>
          <div className={styles.experienceHeader}>
            <h1 className={styles.sampleItem}>UC San Diego</h1>
            <div className={styles.frame1}>
              <div className={styles.locationDateContainer}>
                <p className={styles.experienceText}>La Jolla, CA</p>
                <p className={styles.experienceText}>09/2021 - 06/2022, 09/2023 - Present</p>
              </div>
            </div>
          </div>
